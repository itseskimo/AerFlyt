      ...
      <Layout>
        ...
        <main className='grid grid-cols-1 lg:grid-cols-[auto,450px] gap-20'>
          ...
          <aside className=' flex flex-col gap-6 mt-[-60px] order-2 lg:order-1'>
            ...
            <header className={`hidden lg:flex   items-center gap-1 justify-center bg-[#222222] text-white p-2  w-full text-[0.875rem]  rounded-[1.25rem] border-solid border-[#7A757F] border-[0.5px]`}>
