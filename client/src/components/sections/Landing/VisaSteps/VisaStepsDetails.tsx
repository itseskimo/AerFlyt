  ...
  return (
    <main className="grid grid-cols-[1fr,80px,1fr] ">
        ...
        <aside className="flex flex-col gap-8">
          ...
          <h1 className="text-visaBlue flex gap-2 items-center">Step 1:<span className="font-semibold text-[1.25rem]">Select your destination</span> </h1>
          <p className="text-[#5C5F5F]">Search for the country/Select a country from the list to start your VISA application process.</p>

          <div className="bg-[#FFFBFF] p-4 rounded-[1.25rem] shadow-listBoxShadow">
            <h1 className="flex items-center gap-3 text-[1.25rem] mb-2">
              ...
              Provide other details about your VISA requirement
            </h1>
          ...
          <div className="flex flex-col gap-4">
            <h1 className="text-[#222222] flex gap-2 items-center font-bold">Step 3:<span className=" text-[1.25rem]">VISA delivery via mail</span> </h1>
            <p className="text-[#5C5F5F]">Get your approved E-VISA delivered to your registered email id to download.</p>
          </div>

          <div className="bg-[#FFFBFF] p-4 rounded-[1.25rem] border-solid border-[0.5px] border-visaGrey">
            <h1 className="flex items-start gap-3 text-[1.25rem] mb-2">
              <svg className="w-max" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              E-VISA gets approved post all the documents are processed sucessfully
            </h1>

            <p className="text-[#5C5F5F] ml-8">DFFFFFFFFFFF</p>
          </div>
        ...
        <aside className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="text-[#222222] flex gap-2 items-center font-bold">Step 2:<span className=" text-[1.25rem]">Upload documents and pay online</span> </h1>
            <p className="text-[#5C5F5F]">Upload traveler’s scanned documents for verification and pay the required amount online to start your VISA processing</p>
          </div>
