...
const CountryVisaSteps = () => {
    return (
        <>
            <h5 className='text-[1.25rem] md:text-[1.5rem] font-bold pb-6'>Singapore E-VISA process after applying</h5>

            <main className="grid grid-cols-[80px,auto] ">


                <section className="w-[1px] justify-self-center bg-[#222222] relative rounded-md flex flex-col items-center justify-between h-full">
                ...
                <section className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-8">
                        <h1 className="flex gap-2 items-end text-[1rem] xl:text-[1.25rem] font-semibold flex-wrap">Step 1:<span className="font-bold text-[1.25rem] xl:text-[1.5rem]"> Documents sent to Dept. of Immigration</span> </h1>
                        <p className=" text-[0.875rem] lg:text-[1rem]">Search for the country/Select a country from the list to start your VISA application process.</p>

                        <div className="bg-[#FFFBFF] p-4 rounded-[1.25rem] shadow-listBoxShadow border-solid border-[1px] border-[#7214FF]">
                            <h1 className="flex items-start gap-3 text-[1rem] lg:text-[1.25rem] mb-2">
                                ...
                                <span className='mt-[-2px] text-[1.25rem]'>Provide other details about your VISA requirement</span>
                            </h1>
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="text-[#222222] flex gap-2 items-end text-[1rem] xl:text-[1.25rem] font-semibold flex-wrap">Step 2:<span className="font-bold text-[1.25rem] xl:text-[1.5rem] ">Immigration dept. performs security checks</span> </h1>
...
export default CountryVisaSteps